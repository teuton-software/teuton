...
& "$env:ProgramFiles\7-Zip\7z" e -y -o "$env:ProgramFiles\wget" "$dest\wget-1.11.4-1-bin.zip"
& "$env:ProgramFiles\7-Zip\7z" e -y -o "$env:ProgramFiles\wget" "$dest\wget-1.11.4-1-dep.zip"
