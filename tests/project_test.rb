...
class ProjectTest < Minitest::Test
  def test_find_filenames_for
    ...
    script_path, config_path, test_name = Project.find_filenames_for('tests/files/example-05')
    assert_equal 'tests/files/example-05/start.rb', script_path
    assert_equal 'tests/files/example-05/config.json', config_path
    assert_equal 'example-05', test_name
